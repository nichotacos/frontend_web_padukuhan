    ...
    return (
        <>
            <div className='bg-lime-100'>
                <div className="h-screen flex flex-col-reverse md:flex-row lg:flex-row items-center justify-center content-between gap-4 lg:gap-12">
                    <div className=" bg-duwet-primary w-5/6 md:w-4/6 lg:w-3/6 rounded-lg">
                        <p className="font-poppins text-lg lg:text-4xl font-bold text-white px-2 lg:px-16 pt-4 lg:pt-16 pb-4 md:pb-8 lg:pb-8">Sambutan Dukuh</p>
                        <p className={textClass + " pb-2 lg:pb-8"}>Assalamu&apos;alaikum warahmatullahi wabarakatuh,</p>
                        ...
                        <p className={textClass + " py-2 lg:py-8"}>Wassalamu&apos;alaikum warahmatullahi wabarakatuh.</p>
