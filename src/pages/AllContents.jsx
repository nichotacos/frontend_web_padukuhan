...
export default function AllContents() {
    ...
    return (
        <>
            <div className="bg-duwet-primary flex flex-row justify-center align-middle">
                <div className="mt-8 w-3/4 flex flex-col justify-center items-center align-middle mb-8">
                    <p className="font-poppins text-4xl font-semibold mb-8 text-white w-1/3 text-center bg-duwet-secondary py-4 rounded-2xl">Semua Berita</p>
