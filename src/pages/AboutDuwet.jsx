        ...
        <>
            <div className="bg-duwet-main-bg">
                <div className="h-screen lg:h-screen flex flex-row items-center justify-center lg:justify-start">
                    <div className="w-0 h-0 md:h-4/6 md:w-7/12 lg:h-4/6 lg:w-7/12 overflow-hidden invisible lg:visible">
                        <img src={embung} alt="duwet" className="scale-150 rounded-xl" />
                    </div>
                    <div className="lg:absolute lg:right-80 bg-duwet-primary w-3/4 lg:w-2/6 rounded-lg">
