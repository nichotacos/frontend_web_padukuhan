            ...
            <div className="bg-duwet-main-bg">
                <div className=" h-screen flex flex-row items-center">
                    ...
                    <div className="absolute right-80 bg-duwet-primary w-2/6 rounded-lg">
                        <p className="font-poppins text-5xl font-bold text-white px-16 pt-16 pb-4">Tentang Duwet</p>
                        <p className="text-white font-inter text-base font-semibold px-16 pt-4 pb-16">Padukuhan Duwet adalah sebuah padukuhan yang
